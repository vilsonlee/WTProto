...
/*
 Vilson: XMPPStreamCompressionMode
 */
typedef NS_ENUM(NSUInteger, XMPPStreamCompressionMode) {
    XMPPStreamCompressionNoneMode   = 0,        //NO_COMPRESSION
    XMPPStreamCompressionBestSpeed,             //BEST_SPEED
    XMPPStreamCompressionBestCompression,       //BEST_COMPRESSION
    XMPPStreamCompressionDefaultCompression,    //DEFAULT_COMPRESSION
};


/*
 Vilson: XMPPStreamCompressionState
 */
typedef NS_ENUM(NSUInteger, XMPPStreamCompressionState){
    XMPPStreamCompressionStateNegotiating,               //Stream Compression state is Negotiating
    XMPPStreamCompressionStateRequestingCompress,        //Stream Compression state Requesting Compress
    XMPPStreamCompressionStateCompressing,               //Stream Compression is Compressing
    XMPPStreamCompressionStateFailureUnsupportedMethod,  //Stream Compression Unsupported Some Method
    XMPPStreamCompressionStateFailureSetupFailed,        //Stream Compression Set Fail
};
 ...
 *
 * XEP-0138
 * If set, the Stream Compression is performed. Currently only zlib compression is supported.
 * According to XEP-0138, this property is invalid if TSL compression is implemented.
 *
 * The default value is NO.
 **/

@property (readwrite, assign) BOOL openStreamCompress;


/** Vilson:
 *
 * XEP-0138
 * Set stream compression mode.
 * This mode is not valid if the 'openStreamCompress' is set to NO
 *
 * XMPPStreamCompressionNoneMode,           // no compression
 * XMPPStreamCompressionBestSpeed,          // the best compression speed
 * XMPPStreamCompressionBestCompression,    // the best compression effect
 * XMPPStreamCompressionDefaultCompression, // the default compression effect
 *
 **/

@property (readwrite, assign) XMPPStreamCompressionMode streamCompressionMode;
 ...
 * This method is called after registration of a new user has successfully finished.
 * If registration fails for some reason, the xmppStream:didNotRegister: method will be called instead.
 * The Origin "xmppStreamDidRegister" Method does not return the response,so add this new delegate Method
**/
- (void)xmppStreamDidRegister:(XMPPStream *)sender response:(NSXMLElement *)response;
